...
class _CarInfoScreenState extends State<CarInfoScreen> {
  ...
  saveCarInfo() {
    ...
    Fluttertoast.showToast(
        msg: "Les détails de la voiture ont été enregistrés. Félicitation");
    Navigator.push(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text(
                " Écrire les détails de la voiture",
                style: TextStyle(
                  fontSize: 26,
                  color: Colors.grey,
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: "Couleur de la voiture ",
                  enabledBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.grey)),
                  focusedBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.grey)),
              ...
              DropdownButton(
                ...
                hint: const Text(
                  "Veuillez choisir le type de voiture",
                  style: TextStyle(
                    fontSize: 14.0,
                    color: Colors.grey,
                  ),
